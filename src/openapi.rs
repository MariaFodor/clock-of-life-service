...
pub fn openapi_doc() -> Value {
    json!({
        ...
        "paths": {
            ...
            "/api/whatif": { "post": optional_auth_op("Lifestyle-change overlay (levers incl. cigarettes/day, diet/alcohol/sitting/stress; sleep is refused as a marker); persists a scenario if base given", "scoring") },
